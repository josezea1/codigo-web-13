...
const urlHomer =
  "https://cdn.eldeforma.com/wp-content/uploads/2020/03/2rfd59.png";
...
btnAlertCustom.onclick = function () {
  Swal.fire({
    ...
    background: `url(${urlHomer})`,
    color: "#fff",
    backdrop: `
    rgba(0,0,0,0.3)
    url(https://media.giphy.com/media/xT5LMHxhOfscxPfIfm/giphy.gif) top no-repeat`,
...
const alertaInputs = document.querySelector("#btn-alerta-inputs");
alertaInputs.onclick=function(){
  Swal.fire({
    title:"Input para email",
    input:"email",
    inputLabel:"Ingrese su correo",
    inputPlaceholder:"El correo debe ser valiso",
  }).then((resultado)=>{
